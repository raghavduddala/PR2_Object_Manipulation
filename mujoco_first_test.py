...
# model = load_model_from_path("mujoco-py/xmls/fetch/main.xml")
# # model = load_model_from_path("mujoco-py/xmls/juggler.xml")
# sim = MjSim(model)
...
# import pytest
# import random
# from mujoco_py import (MjSim, load_model_from_xml, cymj, MjViewer)
...
# ###
# # Undrestand the whole code by tomorrow and also the rest of the functions used in the 
# # mujoco_py and mujoco
# # So that we can implement a basic position basd control and also LQR and see how it performs
# # iLQR or 
# # and also on DDPG and see if it works 
